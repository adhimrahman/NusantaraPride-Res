...
Config.Discord = {
    ...
    applicationId = '829683831845552200',                   -- The discord application id
    iconLarge = '31',                               -- The name of the large icon
    iconLargeHoverText = 'Nusantara Pride', -- The hover text of the large icon
    iconSmall = 'verif',                         -- The name of the small icon
    iconSmallHoverText = 'nusantarapride.id', -- The hover text of the small icon
